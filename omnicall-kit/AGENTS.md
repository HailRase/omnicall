# OmniCall Kit Agent Contract

This file is the mandatory entry point for every agent working in `omnicall-kit/`.

## Mission

Build a small, stable, secure, and strictly typed browser client for OmniCall Desktop.
...
- Prefer `OmniCallClient`; reserve “agent” for an autonomous product concept.
