...
| Scope | `omnicall-kit/` + factual registry/evidence/work-history only — **no** desktop `src/` product edits |
...
| `OMNICALL_SDK_BROWSER=1 npm run test:browser` | **7** passed (6 files) — unchanged |
