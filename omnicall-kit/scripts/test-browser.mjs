...
const runBrowser = process.env.OMNICALL_SDK_BROWSER === '1' || process.env.CI === 'true';

if (!runBrowser) {
  console.log(
    'Skipping Playwright browser execution (set OMNICALL_SDK_BROWSER=1 after `npx playwright install chromium`).'
  );
