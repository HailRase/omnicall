---
name: omnicall-kit-implementation
description: Implements one approved OmniCall browser SDK work unit with strict protocol, security, compatibility, testing, and handoff gates. Use for SDK-00 through SDK-10 work in the standalone SDK project.
disable-model-invocation: true
---

# OmniCall Kit Implementation
...
- Keep both independent from OmniCall Desktop internals.
