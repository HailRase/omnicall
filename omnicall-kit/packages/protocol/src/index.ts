/**
 * `@softomnitel/omnicall-protocol` — runtime schemas and inferred types for OmniCall local protocol v1.
 *
 * Schemas are the source of truth (ADR-0014). Types are inferred. This package must not
 * import `@softomnitel/omnicall-kit` or desktop Domain/Application/Electron/React source.
 *
