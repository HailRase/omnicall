...
describe('@softomnitel/omnicall-kit workspace smoke', () => {
  it('exports OmniCallClient factory without root mutation symbols', async () => {
    const mod = await import('./index.js');
    expect(typeof mod.createAuthClient).toBe('function');
    expect(typeof mod.createOmniCallClient).toBe('function');
