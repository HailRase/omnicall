...
describe('OmniCallClient activate privilege fortress', () => {
...
describe('OmniCallClient activateProfile success and fail-closed', () => {
...
describe('OmniCallClient activate reconnect / disconnect / privacy', () => {
...
describe('OmniCallClient activate events honesty', () => {
