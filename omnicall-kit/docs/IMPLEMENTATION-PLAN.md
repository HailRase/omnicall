# OmniCall Kit Implementation Plan
...
1. Confirm Node LTS compatibility with OmniCall Desktop (`>=20.19.0` baseline).
...
Purpose: implement `@softomnitel/omnicall-protocol` first.
...
- `OmniCallClient.connect`, `disconnect`, connection state, and `getSnapshot`;
