---
name: omnicall-kit-integration
description: Implements one F-011/P12 OmniCall Desktop SDK integration work unit across Electron main, typed IPC, Application routing, security, events, settings, and compatibility tests. Use for DI-00 through DI-11.
...
6. `omnicall-kit-integration/AGENTS.md`
7. `omnicall-kit-integration/00-SNAPSHOT.md`
8. `omnicall-kit-integration/IMPLEMENTATION-PLAN.md`
9. `omnicall-kit-integration/WORK-UNITS.md`
10. `omnicall-kit-integration/TEST-MATRIX.md`
11. `omnicall-kit-integration/SMOKE-CHECKLIST.md`
12. `omnicall-kit/docs/PROTOCOL.md`
13. `omnicall-kit/docs/SECURITY.md`
