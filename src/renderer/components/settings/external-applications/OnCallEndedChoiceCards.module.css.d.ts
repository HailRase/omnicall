declare const classes: {
  ...
  readonly sceneCloseWindow: string;
  readonly sceneLeaveWindow: string;
  readonly sceneMinimizeStrip: string;
  readonly sceneMinimizeWindow: string;
  ...
  readonly schematicMinimizeStrip: string;
