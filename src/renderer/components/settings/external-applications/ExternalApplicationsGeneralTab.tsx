 ...
 * - Inputs: open mode, window size, busy flag, change callback.
 * - Outputs: presentational open-mode and size intents.
 */

import type { ChangeEvent, JSX } from "react";
import { useI18n } from "../../../i18n/index.js";
import { FormField, Input, Select } from "../../ui/index.js";
    ...
    <div className={styles.editorGrid}>
          ...
          items={[
            {
              ...
              label: t("settings.integrations.externalApplications.openMode.electronWindow"),
            },
            {
              value: "external_browser",
              label: t("settings.integrations.externalApplications.openMode.externalBrowser"),
            },
          ]}
      ...
      <FormField label={t("settings.integrations.externalApplications.window.width")}>
        <Input
          ...
          disabled={busy || application.openMode !== "electron_window"}
          onChange={(event) => {
            update({
              window: {
                ...application.window,
        ...
        <Input
          ...
          onChange={(event) => {
            update({
              window: {
                ...application.window,
                height: updateNumber(event, application.window.height, MIN_HEIGHT, MAX_HEIGHT),
              },
            });
          }}
        />
