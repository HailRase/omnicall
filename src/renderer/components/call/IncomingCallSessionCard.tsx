...
/**
 * - Purpose: selectable incoming call session card in the call context zone (F-002/F-027).
 * - Inputs: caller identity, selection state, audio/video answer callbacks.
 * - Outputs: green session card with answer/video/reject controls; intents via props only.
