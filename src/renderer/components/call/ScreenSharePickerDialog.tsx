...
export type ScreenSharePickerDialogProps = Readonly<{
  ...
  onActiveKindChange: (kind: DisplayCaptureSourceKind) => void;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={styles.tabs} role="tablist" aria-label={t("call.video.screenShare.picker.tabsAria")}>
          <button
            type="button"
            role="tab"
            aria-selected={activeKind === "screen"}
            className={`${styles.tab}${activeKind === "screen" ? ` ${styles.tabActive}` : ""}`}
          ...
          <button
            ...
            className={`${styles.tab}${activeKind === "window" ? ` ${styles.tabActive}` : ""}`}
        ...
        <div className={styles.grid} data-testid="screen-share-picker-grid">
          {loading ? (
                ...
                return (
                  ...
                  >
                    {source.thumbnailDataUrl !== null ? (
                      ...
                      <img
                        className={`${styles.thumb} ${styles.thumbIcon}`}
