...
Полная установка и сборка: [`install-instruction.md`](install-instruction.md).
...
3. На главном экране нажмите **Войти в аккаунт** под надписью «Чтобы звонить, войдите в аккаунт» — откроются **Настройки → Аккаунт**.  
   Альтернатива: аватар в шапке → **Настройки** (раздел Аккаунт откроется сам, пока вы не вошли).
4. Введите данные SIP от администратора (или вкладку модуля ОСР, если так выдано):
...
5. Нажмите **Войти** / **Авторизоваться**.
