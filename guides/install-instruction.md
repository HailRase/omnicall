...
3. Нажмите **Войти в аккаунт** в зоне ожидания звонка (под надписью «Чтобы звонить, войдите в аккаунт») — откроется **Настройки → Аккаунт**.  
   Альтернатива: аватар → **Настройки** (Аккаунт выбран по умолчанию до входа).
4. При пустом списке сохранённых профилей сверху показана короткая подсказка первого входа.
5. Заполните поля:
...
6. Нажмите **Войти** / **Авторизоваться**.
