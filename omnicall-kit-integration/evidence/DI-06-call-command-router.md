...
1. **SDK-06 client package** may still be `pending` — desktop server routing consumes `@softomnitel/omnicall-protocol` schemas/fixtures; full client interoperability is a paired SDK gate (mirror DI-05 / SDK-05 note).
...
Docs: `omnicall-kit/docs/PROTOCOL.md`, `omnicall-kit/docs/guide/errors.md`, Feature Registry F-003/F-011.
