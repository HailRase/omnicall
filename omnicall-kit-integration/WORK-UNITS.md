...
- Files added/changed:
  ...
  - `omnicall-kit-integration/evidence/DI-00-baseline.md`
  - `omnicall-kit-integration/00-SNAPSHOT.md`
  - `omnicall-kit/docs/PROTOCOL.md` (open decisions table)
...
Prerequisites: DI-00 and SDK-01 done; SDK-02 `@softomnitel/omnicall-protocol` done (peer consume).
...
- Layers allowed: Ports + Application-boundary adapters/tests; consume `@softomnitel/omnicall-protocol`
  outside Domain only.
...
- Regression risks (refuse to break):
  ...
  5. No Domain import of Zod / `@softomnitel/omnicall-protocol` / Electron / IPC
...
- Layers changed: Ports + mock adapters + tests; `package.json` file dep on `@softomnitel/omnicall-protocol`; eslint Domain restriction + `omnicall-kit/**` ignore
- Files added/changed:
  ...
  - `omnicall-kit-integration/evidence/DI-01-protocol-ports-mocks.md`
...
- Evidence: `omnicall-kit-integration/evidence/DI-01-protocol-ports-mocks.md`
...
- Files added/changed:
  ...
  - `omnicall-kit-integration/evidence/DI-02-typed-main-renderer-broker.md`
...
- Evidence: `omnicall-kit-integration/evidence/DI-02-typed-main-renderer-broker.md`
...
- Files added/changed:
  ...
  - `omnicall-kit-integration/evidence/DI-03-loopback-websocket-transport.md`
...
- Evidence: `omnicall-kit-integration/evidence/DI-03-loopback-websocket-transport.md`
...
- Files added/changed:
  ...
  - evidence `omnicall-kit-integration/evidence/DI-04-pairing-origin-capabilities.md`
...
- Files added/changed:
  ...
  - evidence `omnicall-kit-integration/evidence/DI-05-read-only-snapshot-events-window-show.md`
...
- Expected files:
  ...
  - evidence `omnicall-kit-integration/evidence/DI-06-call-command-router.md`
...
- Evidence: `omnicall-kit-integration/evidence/DI-07-operator-logout-workflow.md`
...
- Status: **`done`**
- Evidence: `omnicall-kit-integration/evidence/DI-08-saved-profile-activation.md`
...
- Work unit: DI-09
- Status: **`done`**
- Evidence: `omnicall-kit-integration/evidence/DI-09-settings-operational-ux.md`
...
> OmniCall Kit (ADR-AF-004 exception), discovery CORS for unknown+allowed, and
...
- [x] Pre-auth Settings → OmniCall Kit; OCP Module remains gated (AF-004 derive helper).
...
- Evidence: `omnicall-kit-integration/evidence/DI-11-origin-tofu-blacklist-activate.md`
