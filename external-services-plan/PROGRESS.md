...
| WU-08 | Navigation and collections UI | done | 2026-07-29 | Settings leaf `integrations-external-services`; Application summaries/mutations; shell/actions/panel hooks; collections/variables UI; i18n ru/en/fr/de/bg; nav/panel/component tests + light/dark stories; `typecheck`/`i18n:check`/`ui:catalog` PASS |
| WU-09 | Requests editor and Run now UI | done | 2026-07-29 | Requests list/editor/run result components, request mutation hook, unsaved-discard confirmation, ru/en/fr/de/bg i18n, light/dark stories; focused tests, typecheck, i18n:check, ui:catalog, targeted lint PASS |
| WU-10 | Journal UI | done | 2026-07-29 | Journal panel VM + `useExternalServicesJournal`; `ExternalServicesJournal` accordion at collections bottom (cap 100, redacted headers, truncation); empty/loading/error/retry; ru/en/fr/de/bg i18n; projection/component tests + light/dark stories; `typecheck`/`i18n:check`/`ui:catalog` PASS |
