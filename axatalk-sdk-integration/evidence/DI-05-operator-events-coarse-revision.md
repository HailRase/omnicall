...
Emit protocol `operator:status-changed` / `operator:session-changed` from Axatalk desktop
...
- `axatalk-sdk/docs/guide/events.md` — host recipe + coarse-advance
- `axatalk-sdk/docs/guide/errors.md` — `stale_state` after UI/OCP coarse change
- `axatalk-sdk-integration/evidence/DI-05-read-only-snapshot-events-window-show.md` — follow-up section
