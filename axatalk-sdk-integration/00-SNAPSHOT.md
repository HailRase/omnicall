...
- F-011 Host Integration Contract: `in progress` (DI-01…DI-05 `done`; next DI-06)
- P12 External Host API Compatibility: architecture closed (DI-00); DI-01…DI-05 `done`; next DI-06
