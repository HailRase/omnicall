...
| `OcpStatusDropdown` | `src/renderer/components/integration/ocp/OcpStatusDropdown.tsx` | `OcpStatusDropdownProps` | ocp-status-dropdown | — |
...
| `OcpModuleSettingsCard` | `src/renderer/components/settings/panels/OcpModuleSettingsCard.tsx` | `OcpModuleSettingsCardProps` | ocp-module-settings-card, ocp-module-enabled-toggle, ocp-module-domain-input, ocp-module-auto-connect-toggle, ocp-module-auto-sip-auth-toggle, ocp-module-token-input, ocp-module-token-visibility-toggle, ocp-module-token-save, ocp-module-token-delete, ocp-module-token-saved-hint, ocp-module-status, ocp-module-enable-first-hint, ocp-module-connect, ocp-module-disconnect, ocp-module-error | f=F-028 lf=LF-018,LF-019 |
