...
| `AccountPanel` | `src/renderer/components/account/AccountPanel.tsx` | `—` | account-panel, account-mode-tabs, account-mode-sip, account-mode-ocp, account-error, account-username, account-forget-saved-password, account-domain, account-server, account-password-hint, account-ocp-login, account-ocp-login-select-trigger, account-ocp-login-options, account-ocp-login-option, account-ocp-domain, account-ocp-api-key, account-ocp-api-key-visibility-toggle, account-save-profile-row, account-save-profile-checkbox, account-remember-password-row, account-remember-password-checkbox, account-recovery-actions, account-authorize | — |
...
| `SettingsNotificationHistoryPanel` | `src/renderer/components/settings/panels/SettingsNotificationHistoryPanel.tsx` | `—` | settings-notification-history, settings-notification-history-empty, settings-notification-history-loading, settings-notification-history-error | — |
