...
| `IncomingCallOverlay` | `src/renderer/components/call/IncomingCallOverlay.tsx` | `IncomingCallOverlayProps` | incoming-call-overlay-anchor, incoming-call-overlay, incoming-call-overlay-dismiss, incoming-call-overlay-body, caller-identity, auto-answer-countdown, answer-call, answer-call-video, reject-call | lf=LF-013,LF-014 f=F-002 smoke=R3-2 |
| `IncomingCallSessionCard` | `src/renderer/components/call/IncomingCallSessionCard.tsx` | `IncomingCallSessionCardProps` | incoming-call-session-select, caller-identity, incoming-call-status-label, auto-answer-countdown, incoming-answer-disabled-reason, reject-call, answer-call, answer-call-video | lf=LF-013,LF-014 f=F-002,F-027 smoke=R3-2 |
...
| `SettingsVideoPanel` | `src/renderer/components/settings/panels/SettingsVideoPanel.tsx` | `SettingsVideoPanelProps` | settings-video-panel, settings-video-mic-select, settings-video-camera-select, settings-video-preview-frame, settings-video-preview, settings-video-preview-error, settings-video-devices-error, settings-video-refresh-devices, settings-video-default-view-select, settings-video-auto-fullscreen-toggle, settings-video-conference-substring | — |
