...
| `AccountPanel` | `src/renderer/components/account/AccountPanel.tsx` | `—` | account-panel, account-username, account-domain, account-server, account-password-hint, account-save-profile-row, account-save-profile-checkbox, account-remember-password-row, account-remember-password-checkbox, account-authorize-via-ocp-row, account-authorize-via-ocp-checkbox, account-authorize, account-forget-remembered-password, account-logout | — |
...
| `OcpStatusDropdown` | `src/renderer/components/integration/ocp/OcpStatusDropdown.tsx` | `OcpStatusDropdownProps` | ocp-status-dropdown, ocp-status-current | — |
...
| `OcpModuleSettingsCard` | `src/renderer/components/settings/panels/OcpModuleSettingsCard.tsx` | `OcpModuleSettingsCardProps` | ocp-module-settings-card, ocp-module-enabled-toggle, ocp-module-login-input, ocp-module-login-datalist, ocp-module-domain-input, ocp-module-auto-connect-toggle, ocp-module-api-key-input, ocp-module-api-key-visibility-toggle, ocp-module-api-key-save, ocp-module-api-key-delete, ocp-module-api-key-saved-hint, ocp-module-status, ocp-module-enable-first-hint, ocp-module-login-required-hint, ocp-module-connect, ocp-module-disconnect, ocp-module-error | f=F-028 lf=LF-018,LF-019 |
