...
| `ExternalServicesResponsePane` | `src/renderer/components/settings/external-services/ExternalServicesResponsePane.tsx` | `ExternalServicesResponsePaneProps` | external-services-response-pane, external-services-response-resize, external-services-response-empty | f=F-031 |
...
| `ExternalServicesVariablesDialog` | `src/renderer/components/settings/external-services/ExternalServicesVariablesDialog.tsx` | `ExternalServicesVariablesDialogProps` | external-services-collection-variables-editor, external-services-variables-example, external-services-variables-system-warning | f=F-031 |
