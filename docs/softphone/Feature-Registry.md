...
- Context: Settings
- Priority: high
- Status: **in_progress** (P11 WU4 settings schema 2026-06-25; WU3 header/collapse; WU0 layout + WU1 settings + WU2 call line UX done)
- Owner: TBD
...
- Implementation evidence (UI-4 foundation): `src/renderer/styles/tokens.css`, `globals.css`, `UserAvatar.module.css`, `RegistrationStatusDot.module.css`, `SoftphoneShellHeader.module.css` (WU5 Slice A), `SettingsOverlay.module.css`, `ShellOverlaySheet.module.css` (WU5 Slice B), `CallLineRow.module.css` (WU5 Slice C), `Dialpad.module.css` (WU5 Slice D), `P11-CSS-Modules-Tokens-Migration.md`, `handoffs/P11-WU5-CSS-Modules-Tokens-Agent-Prompt.md`, `handoffs/P11-WU5-Slice-A-Shell-Header-Handoff.md`, `handoffs/P11-WU5-Slice-B-Overlay-Sheets-Handoff.md`, `handoffs/P11-WU5-Slice-C-Call-Line-Row-Handoff.md`, `handoffs/P11-WU5-Slice-D-Dialpad-Handoff.md`
