...
- Context: Integration
- Priority: critical
- Status: **in progress** (legacy `window.Softphone` **not ported**; architecture gate DI-00 `done`; SDK-00…SDK-09 `done`; SDK-10 **`pending`**; DI-01…DI-09 **`done`**; DI-10 **`blocked`** — awaits explicit `/sdk-integration` DI-10 intake (not auto-started; no waiver); F-011 not implemented)
- Owner: TBD
...
- SDK-09 evidence: `axatalk-sdk/evidence/SDK-09-developer-docs-examples.md` (`done` — developer guide + fake-peer example; not published; SDK-10 pending)
