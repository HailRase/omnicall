...
- Implementation evidence (WU-12): acceptance/docs closeout; v13 fixture/lint remediation; full gates (`test`/`typecheck`/`lint`/`i18n:check`/`ui:catalog`/`registry:check`) PASS; SemVer MINOR pending explicit ship auth.
