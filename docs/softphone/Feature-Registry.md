...
- Context: Integration
- Priority: critical
- Status: **in progress** (legacy `window.Softphone` **not ported**; architecture gate DI-00 `done`; SDK-00…SDK-03 `done`; DI-01…DI-05 **`done`**; DI-06 call router next; F-011 not implemented)
- Owner: TBD
