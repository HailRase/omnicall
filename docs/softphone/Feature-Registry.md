...
- Implementation evidence (UI-4 foundation): `src/renderer/styles/tokens.css`, `globals.css`, `UserAvatar.module.css`, `RegistrationStatusDot.module.css`, `SoftphoneShellHeader.module.css` (WU5 Slice A), `P11-CSS-Modules-Tokens-Migration.md`, `handoffs/P11-WU5-CSS-Modules-Tokens-Agent-Prompt.md`, `handoffs/P11-WU5-Slice-A-Shell-Header-Handoff.md`
