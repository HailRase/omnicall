...
| --- | --- | --- | --- | --- | --- | --- |
| T-001 | 1 | Icon tooltips (1s delay) | F-016 | `/ui` | pending | `handoffs/P11-Icon-Tooltips-Agent-Prompt.md` |
| T-002 | 2 | Wire AppIcon in header/call controls | F-016 | `/ui` | pending | `Icon-Registry.md` |
