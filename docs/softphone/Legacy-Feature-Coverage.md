...
| LF-081 | P12 | Integration | High | `legacy status module` external status API | `uselegacy status selectorAPIAdapter` | Public operator DTO/command landed DI-07 (`callType: 'sdk'`); DI-10 live OCP/operator packaged smoke **OPEN** — LF **not closed**. |
