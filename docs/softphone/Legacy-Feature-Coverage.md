...
| LF-051 | P12 | Integration | High | External call button block | `setCallButtonDisabled` | Capability/command policy landed DI-06; DI-10 packaged handshake/hostile evidence partial — **not closed** until full smoke; see `axatalk-sdk-integration/evidence/DI-10-compatibility-e2e-p12-close.md`. No browser global. |
