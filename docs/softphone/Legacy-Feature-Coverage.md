...
| LF-008 | P08 | Telephony | High | Repeat SIP registration after failure | `DisplayProvider`, user config | WU2: `ConnectionRecoveryOrchestrationService`, `ReconnectScheduler`, `SipReconnect*`, `reconnectTransport` — see `handoffs/archive/P08/P08-WU2-Recovery-Orchestration-Handoff.md`. |
| LF-009 | P08 | UI | Medium | Re-registration timer UI | `RegisterTimer` | WU4: `useReconnectCountdown`, `ConnectionOverlay` countdown from `nextRetryAt` (LF-057 parity) — see `handoffs/archive/P08/P08-WU4-Recovery-Manual-Shutdown-Handoff.md`. |
| LF-010 | P08 | Telephony | Medium | Manual re-registration from menu | `Header`, `UserMenu` | WU4: `RetryConnectionUseCase`, `control-reregister-sip`, `control-retry-connection` — see `handoffs/archive/P08/P08-WU4-Recovery-Manual-Shutdown-Handoff.md`. |
