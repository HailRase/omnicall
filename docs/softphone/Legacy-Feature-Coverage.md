...
| LF-012 | P03 | Media | Critical | Incoming call ringtone | `soundManager`, `newRTCSession` | Incoming call starts ringing through Media service. **F-033 (2026-08-01):** selectable catalog (`incomingRingtoneId`, default `classic` = prior WebAudio dual-tone); Settings → Sessions select + preview; Tone FSM unchanged. |
