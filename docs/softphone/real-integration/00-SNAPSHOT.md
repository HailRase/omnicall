...
- UI: dialpad, incoming modal, active controls, transfer panel, status selector,
  connection overlay, campaign modal, legacy operator platform toasts
...
- **Deferred (ADR-0005):** legacy operator WebSocket removed operator — see `ADR-0005`
...
| removed operator | legacy operator WebSocket — **DEFERRED** (ADR-0005) | LF-001–004, LF-037–040 |
