...
| next | `SoftphoneShellHeader`, shell chrome | Header actions still in `styles.css` |
| next | `SettingsOverlay`, `ShellOverlaySheet` | Overlay sheets |
| next | Call line / dialpad / modals | Largest `styles.css` blocks |
