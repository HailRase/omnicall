...
Живой статус релизной линии: `STATUS.md` → **Release train**.
...
| `.cursor/skills/release-agent/SKILL.md` | агент `/release` |

---

## 12. Быстрые ссылки

- Репозиторий: https://github.com/HailRase/softphone-electron  
- Releases: https://github.com/HailRase/softphone-electron/releases  
