...
| F-016 / LF-002 Bootstrap splash (2026-07-24) | Branded boot / init-error splash | `bootstrap.brand`, `bootstrap.loading`, `bootstrap.error.initializationFailed` | migrated | `BootstrapSplashShell.test.tsx`, locale catalogs ru/en/fr/de/bg, `i18n:check` |
