...
**Prepared / next transport auth:** **F-011 / P12 External Host API + Axatalk SDK** — DI-00…DI-08 **`done`**; next **`/sdk-integration` DI-09 only** (Settings / operational UX); SDK-00…SDK-03 **`done`**. Feature status **`in progress`** (not `implemented`).
