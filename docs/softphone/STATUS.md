...
**Prepared / architecture gate closed:** **F-011 / P12 External Host API + Axatalk SDK** — DI-00 **`done`**; **SDK-00** workspace/CI **`done`**; **SDK-01** protocol/security ADRs ADR-0014…0017 **`done`** (`/sdk-review` PASS 2026-07-20; `axatalk-sdk/evidence/SDK-01-protocol-adrs.md`). Feature status remains **`planned`** (no production implementation). Next: **SDK-02** (`@axatalk/protocol`); DI-01 after DI-00 + SDK-01.
