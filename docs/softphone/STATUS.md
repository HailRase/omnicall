...
**Updated:** 2026-07-19
**Tests:** 2276 passed / 1 skipped (F-028 T-048 post-call finish footer)
**Lint / typecheck:** green (last verified 2026-07-19)
...
**Prepared but not claimed:** **F-011 / P12 External Host API + Axatalk SDK** — agent execution packages are ready in `axatalk-sdk/` (SDK-00…SDK-10) and `axatalk-sdk-integration/` (DI-00…DI-10). Start with DI-00 + SDK-00/01; feature status remains `planned`.
