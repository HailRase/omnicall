...
**Prepared / next transport auth:** **F-011 / P12 External Host API + Axatalk SDK** — DI-00…DI-09 **`done`**; next **DI-10** (compatibility / packaged E2E / P12 close — `/sdk-integration` DI-10 only); SDK-00…SDK-03 **`done`**. Feature status **`in progress`** (not `implemented`).
