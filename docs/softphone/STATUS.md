...
**Updated:** 2026-07-20
**Tests:** 2407 passed / 1 skipped (DI-05 **`done`** + Low remediations; `/sdk-review` PASS)
**Lint / typecheck:** green (last verified 2026-07-20 — DI-05 focused 60 + full `npm test` / lint / typecheck / `registry:check` 71/0)
...
**Prepared / next transport auth:** **F-011 / P12 External Host API + Axatalk SDK** — DI-00…DI-05 **`done`**; next **DI-06** call command router via `/sdk-integration`; SDK-00…SDK-03 **`done`**; evidence `axatalk-sdk-integration/evidence/DI-05-read-only-snapshot-events-window-show.md`. Feature status **`in progress`** (not `implemented`).
